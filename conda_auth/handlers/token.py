...
class TokenAuthManager(AuthManager):
    """Manage token credentials and their request header configuration."""
    ...
    def get_header_config(self, channel_name: str) -> tuple[str, str]:
        """Return the validated token header configuration for a channel."""
    ...
    def cache_clear(self, channel_name: str | None = None) -> None:
        """Clear cached credentials and token header configuration."""
...
def get_token_header_config(
    ...
    """Resolve and validate a token header name and value template."""
...
def get_token_header(
    ...
    """Resolve the token header name from settings or stored credentials."""
...
def get_token_template(
    ...
    """Resolve the token value template from settings or stored credentials."""
...
def validate_token_header(header: str) -> None:
    """Require a valid HTTP header field name."""
...
def validate_token_template(template: str) -> None:
    """Require a safe format string containing only the token field."""
